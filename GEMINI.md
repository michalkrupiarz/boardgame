...
### Stack
- Language and version: TypeScript 5.9
- Framework(s): React 19, Vite 8
- Package manager: npm
- Runtime / deployment target: Browser
...
### Layout
- Source lives in: `src/`
- Tests live in: `tests/` (e2e), `src/**/*.test.ts` (unit)

### Conventions specific to this repo
- Naming: camelCase for files and variables
- Import style: ES modules with relative paths
- Error handling pattern: N/A (React UI)
- Testing pattern: Vitest for unit tests, Playwright for E2E
